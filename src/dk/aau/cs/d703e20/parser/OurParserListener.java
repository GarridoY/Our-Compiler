...
public interface OurParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link OurParser#boolOperand}.
	 * @param ctx the parse tree
	 */
	void enterBoolOperand(OurParser.BoolOperandContext ctx);
	/**
	 * Exit a parse tree produced by {@link OurParser#boolOperand}.
	 * @param ctx the parse tree
	 */
	void exitBoolOperand(OurParser.BoolOperandContext ctx);
	/**
	 * Enter a parse tree produced by {@link OurParser#boolOperation}.
	 * @param ctx the parse tree
	 */
	void enterBoolOperation(OurParser.BoolOperationContext ctx);
	/**
	 * Exit a parse tree produced by {@link OurParser#boolOperation}.
	 * @param ctx the parse tree
	 */
	void exitBoolOperation(OurParser.BoolOperationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link OurParser#boolOperator}.
	 * @param ctx the parse tree
	 */
	void enterBoolOperator(OurParser.BoolOperatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link OurParser#boolOperator}.
	 * @param ctx the parse tree
	 */
	void exitBoolOperator(OurParser.BoolOperatorContext ctx);
	/**
