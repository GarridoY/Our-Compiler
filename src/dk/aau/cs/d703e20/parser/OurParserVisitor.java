...
public interface OurParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link OurParser#boolOperand}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBoolOperand(OurParser.BoolOperandContext ctx);
	/**
	 * Visit a parse tree produced by {@link OurParser#boolOperation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBoolOperation(OurParser.BoolOperationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OurParser#boolOperator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBoolOperator(OurParser.BoolOperatorContext ctx);
	/**
